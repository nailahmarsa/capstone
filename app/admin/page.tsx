...
const INITIAL_SPOTS: Spot[] = [
  { id: 1, name: "Museum Layang-Layang", category: "park", img: "/museumlayang.png", updatedAt: new Date().toISOString(), },
  { id: 2, name: "Galeri Salihara", category: "park", img: "/salihara.jpg", updatedAt: new Date().toISOString(), },
  { id: 3, name: "TierSpace", category: "cafe", img: "/tierspace.png", updatedAt: new Date().toISOString(), },
  { id: 4, name: "Perpustakaan Freedom", category: "library", img: "/freedomlib.jpg", updatedAt: new Date().toISOString(), },
  { id: 5, name: "GoWork Fatmawati", category: "cafe", img: "/gowork.png", updatedAt: new Date().toISOString(), },
  { id: 6, name: "Cinere Garden Food Street", category: "cafe", img: "/cinere.jpg", updatedAt: new Date().toISOString(), },
];
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#FAF5F0", display: "flex", flexDirection: "column" }}>
      ...
      <header style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "20px 40px" }}>
        ...
        >
          <span style={{ fontSize: "13px", color: "#555", fontWeight: "500" }}>{admin.name || "Admin"}</span>
          ...
          {latestEdits.map((spot, i) => (
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: "12px", color: "#999" }}>Last edited {timeAgo(spot.updatedAt)}</div>
              </div>
            </div>
          ))}
        </div>
