...
function ReviewModal({ onClose }: { onClose: () => void }) {
  ...
  return (
        ...
        {!submitted ? (
          ...
          <div className="flex flex-col items-center text-center py-4">
            ...
            <p className="text-[12px] text-gray-400 mt-2 max-w-[200px] leading-relaxed">
              Thanks for sharing! Your input helps other users make better choices.
            </p>
          </div>
        )}
      </div>
    ...
    export default function SpotDetailPage() {
      ...
      const place =
        placeData[params.slug as keyof typeof placeData];
      ...
      <div className="relative w-full h-[260px]">
        ...
        <div className="absolute top-5 left-5 right-5 flex items-center justify-between px-2 py-2 rounded-full bg-white/40 backdrop-blur-sm">
          <div className="flex items-center gap-2">
            ...
            >
              <ArrowLeft size={18} className="text-[#2f4b2f]" />
            </button>
          ...
          <button className="w-8 h-8 rounded-full bg-white flex items-center justify-center">
            <Bookmark size={17} className="text-[#2f4b2f]" />
          </button>
        </div>
      </div>
